...
workout=[
    ("Jumping Jacks", "gifs/jumping_jacks.gif", 120),
    ("Squats", "gifs/squats.gif", 120),
    ("Push Ups", "gifs/pushups.gif", 120),
    ("Plank", "gifs/plank.gif", 120),
    ]
...
Button(left_frame, text="🖊 Edit Profile", font=("Times New Roman", 14, "bold"),
...
Label(univ_card, text="INTERMEDIATE SESSION", fg="Aqua", bg="#3e3d41",
      font=("Times New Roman", 16, "bold")).pack(pady=10)

try:
    image = Image.open("inter2.png").resize((600, 300), Image.LANCZOS)
