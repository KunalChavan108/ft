...
workout=[
    ("Jumping Jacks", "gifs/jumping_jacks.gif", 180),
    ("Squats", "gifs/squats.gif", 180),
    ("Push Ups", "gifs/pushups.gif", 180),
    ("Plank", "gifs/plank.gif", 180),
    ]
...
Label(univ_card, text="Advanced SESSION", fg="Aqua", bg="#3e3d41",
      font=("Times New Roman", 16, "bold")).pack(pady=10)

try:
    image = Image.open("adv.png").resize((600, 300), Image.LANCZOS)
